 ...
 * Author: Nan LI
 *
 *   min 0.5*|a-a0|^2 + 0.5*|q-q0|^2  st a>=0   q>=0   1'a=1'q
 *
 * Input:  a0, q0
 * Output:  a, q
 */
...
static double computeProjection(double* a0, double* q0, double* a, double *q, mwIndex m, mwIndex n)
{
...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray*prhs[] )
{
    ...
    lambda = computeProjection(p_a0, p_q0, p_a, p_q, m, n);
    plhs[2] = mxCreateDoubleScalar(lambda);
}
